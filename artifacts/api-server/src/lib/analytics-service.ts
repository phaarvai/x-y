  ...
  static async getManufacturerDashboard(userId: number) {
    ...
    return cached(key, CACHE_TTL_MS, async () => {
      ...
      return {
        ...
        quickActions: [
          { label: "Add Machinery", href: "/browse" },
          { label: "Update Availability", href: "/dashboard/manufacturer" },
          { label: "Respond to Request", href: "/dashboard/manufacturer" },
          { label: "View Messages", href: "/ai-assistant" },
  ...
  static async getVisionaryDashboard(userId: number) {
    ...
    return cached(key, CACHE_TTL_MS, async () => {
      ...
      return {
        ...
        quickActions: [
          { label: "Create Requirement", href: "/dashboard/visionary" },
          { label: "Browse Manufacturers", href: "/browse" },
          { label: "View Messages", href: "/ai-assistant" },
          { label: "Track Booking", href: "/bookings" },
          { label: "Submit Review", href: "/reviews" },
    ...
    return cached(key, CACHE_TTL_MS, async () => {
      ...
      return {
        ...
        legalProfile: legal
          ...
          : null,
        quickActions: [
          { label: "Update Profile", href: "/legal/dashboard" },
          { label: "Publish Service", href: "/marketplace" },
          { label: "Respond to Inquiry", href: "/dashboard/provider" },
