/**
 * Platform password hashing — scrypt (N=16384) with lazy migration from legacy SHA-256.
 * Zero native deps; works in Node 18+ / Next.js API routes.
 */
...
/** Legacy SHA-256 (SESSION_SECRET salt) — kept only for verify + rehash. */
...
/** Password policy for registration / reset (NFR). */
