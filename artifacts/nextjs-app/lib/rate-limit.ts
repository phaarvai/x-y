/**
 * In-memory sliding-window rate limiter with named buckets.
 * Production: swap store for Redis behind the same interface.
 */
...
/** Presets aligned to NFR sensitive endpoints */
